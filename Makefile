...
all: cfr.json cfr-archived.json cfr-fxa.json cfr-fxa-archived.json cfr-heartbeat.json cfr-heartbeat-archived.json whats-new-panel.json whats-new-panel-archived.json messaging-experiments.json 
